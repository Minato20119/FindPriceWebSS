...
public class SearchProFinal {
    ...
    private static final String REGEX_GET_NUMBER_PAGES = "data-page-index=\"";
...
//                    URLConnection connectURL = new URL(urlText).openConnection(proxy);
                    ...
                    try (BufferedReader inputURL = new BufferedReader(new InputStreamReader(
                        ...
                        System.out.println("textFromStreamURL.lastIndexOf(REGEX_GET_NUMBER_PAGES):" + textFromStreamURL.lastIndexOf(REGEX_GET_NUMBER_PAGES));
                        System.out.println("(textFromStreamURL.lastIndexOf(REGEX_GET_NUMBER_PAGES) + 3: " + (textFromStreamURL.lastIndexOf(REGEX_GET_NUMBER_PAGES) + 3));
                        System.out.println("textFromStreamURL.lastIndexOf(REGEX_GET_NUMBER_PAGES_LAST): " + textFromStreamURL.lastIndexOf(REGEX_GET_NUMBER_PAGES_LAST));
                        if (sumPages == 0) {
